...
class UtilsTest {
    @Test @DisplayName("Test correct shuffling") void shuffleDoubleArray() {
    ...
    @Test @DisplayName("Shuffle throws") void testShuffleDoubleArray() {
    ...
    @Test @DisplayName("Test relative accuracy status") void returnRelativeAccuracyStatus() {
    ...
    @Test void testReturnRelativeAccuracyStatus() {
    ...
    @Test @DisplayName("Test data reading") void readTestingValues() {
    ...
    @Test void testReadTestingValues() {
